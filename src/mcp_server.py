...
if __name__ == "__main__":
    ...
    sched_tool = next((t for t in tools if t.get("name") == "book_medical_appointment"), None)
    ...
    test_result = server.call_tool("doctor_schedule_query", {"doctor_name": "Nguyễn Văn An", "specialty": "Nội tổng quát", "facility": "Vinmec Times City", "date_range": "15/09/2026-21/09/2026"})
    if not test_result:
